...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://dipakmandlik.github.io/dipak-mandlik-portfolio/" },
    ...
    links: [{ rel: "canonical", href: "https://dipakmandlik.github.io/dipak-mandlik-portfolio/" }],
    scripts: [
      {
